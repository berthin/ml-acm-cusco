...
\begin{frame}
    ...
    \end{figure}
    \vspace{-.5cm}
    \addsource{https://medium.com/@ageitgey/machine-learning-is-fun-80ea3ec3c471}
\end{frame}
...
\end{table}
    ...
    \only<3>{ 
        \begin{exampleblock}{\small Ejemplo python}
...
\begin{frame}
    ...
    \addsource{https://towardsdatascience.com/types-of-machine-learning-algorithms-you-should-know-953a08248861}
\end{frame}
...
\begin{frame}
    ...
    \addsource{https://cs.nyu.edu/~mohri/mls}
\end{frame}
...
\begin{frame}
    ...
    \end{figure}
    \addsource{https://blog.udacity.com/2016/04/5-skills-you-need-to-become-a-machine-learning-engineer.html}
\end{frame}
...
\begin{frame}
    ...
    \addsource{https://blog.coursera.org/top-6-jobs-computer-science-degree/}
\end{frame}
